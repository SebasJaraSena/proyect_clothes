...
SECRET_KEY = 'django-insecure-0c2d567j*xshwp#epv))+yd6(chgfcmpt221o@s)is&uhp$9d6'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Requiere token para acceder a las vistas protegidas
    ],
